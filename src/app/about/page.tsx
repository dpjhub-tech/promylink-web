...
// Moved here from `/` — the marketing/logged-out homepage. `/` itself is
// now a smart redirect (logged-in -> /dashboard, logged-out -> here). Full
// port of Promylink/src/pages/Index.tsx (logged-out view). The logged-in
// AuthenticatedFeed variant isn't ported — /dashboard replaces that role now.
